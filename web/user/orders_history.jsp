...
<head>
    <title>购物车</title>
    <link href="<%=basePath %>css/index.css"  rel="stylesheet"  rel="stylesheet" type="text/css" />
...
<body>
    <div class="order_head">
        <div class="head_background">
            <div class="head_box">
                <a href="index.html" class="head_left_a"><img src="<%=basePath %>img/logo.jpg" alt="" class="head_left_p"></a>
                <h1 class="head_h1">历史订单</h1>
                <div class="head_right">
                    <span class="head_right_in">${sessionScope.user.name }</span>
                    <span class="head_right_in">|</span>
                    <a href="<%=basePath%>IndexServlet?mark=showIndexData" class="head_right_in">继续购物</a>
                </div>
	           	...
	           	<c:forEach items="${ordersList }" var="orders" >
		           	<tr  style="height: 80px;">
		           		...
		           		<td style="text-align: center;">
		           			<c:forEach items="${orders.trolleys }" var="tro" varStatus="i">
		           				<c:if test="${i.count == 1 }">
		           					${tro.commodity.name }
		           				</c:if>
		           				<c:if test="${i.count != 1 }">
