...
<div class="foot">
 ...
 <div class="fot_bot_max">
     <div class="fot_bot">
         <img src="<%=basePath %>img/logo.jpg" class="fot_bot_logo" >
         ...
         <div class="fot_bot_right">
             <a href="" class="fot_bot_right_img"><img src="<%=basePath %>img/foot_01.png" alt=""></a>
             <a href="" class="fot_bot_right_img"><img src="<%=basePath %>img/foot_02.png" alt=""></a>
             <a href="" class="fot_bot_right_img"><img src="<%=basePath %>img/foot_03.png" alt=""></a>
             <a href="" class="fot_bot_right_img"><img src="<%=basePath %>img/foot_04.png" alt=""></a>
             <a href="" class="fot_bot_right_img"><img src="<%=basePath %>img/foot_05.png" alt=""></a>
         </div>

     </div>
     <img class="fot_bottom_img" src="<%=basePath %>img/foot_06.png">
 </div>
</body>
</html>